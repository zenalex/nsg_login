...
class NsgLoginParams implements NsgLoginParamsInterface {
  ...
  ///Доступна ли регистрация в приложении
  bool enableRegistration;

  ///Заголовок вместо кнопок (если регистрация `enableRegistration` = false)
  String loginHeaderText;
  ...
  NsgLoginParams({
    ...
    this.loginHeaderText = 'Авторизация',
